    ...
    case REG_TYPE_C:
        {
            ...
            else       //如果是从PLC读取的数据
            {
                ...
                {
                    uint nTmpValue1 = (PlcMathMethod::asciiToIntValue(valueList.at(4*i + 2)) << 12) & 0xf000;
                    uint nTmpValue2 = (PlcMathMethod::asciiToIntValue(valueList.at(4*i + 3)) << 8) & 0x0f00;
                    uint nTmpValue3 = (PlcMathMethod::asciiToIntValue(valueList.at(4*i + 0)) << 4) & 0x00f0;
                    uint nTmpValue4 = (PlcMathMethod::asciiToIntValue(valueList.at(4*i + 1)) << 0) & 0x000f;
