    ...
    case REG_TYPE_F:
        {
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= 4096)
                {
                    mTmpAddr.sAddrValue = "";
...
CMN_RW_ERROR_CODE PlcProtocol::checkRcvData(UNPACK_NEED_PROP &mUnpackProp, vector<uchar> rcvList, CHECK_TYPE eCheckType)
{
    ...
    if (rcvList.at(0) == 0x06 && rcvList.at(nRcvSize - 1) == 0x04)
    {
        uchar nRcvHighByte = rcvList.at(nRcvSize - 3);//PLC返回数据中的校验
...
bool PlcProtocol::makeReadPackage(CMN_NEED_PROP mCmnProp, unsigned int &nCmnTimes, SEND_PACKAGE &mSendPackge)
{
    ...
    case REG_TYPE_C:
        {
            mSendPackge.sendDataList.push_back(0x02);//开始符

            mSendPackge.sendDataList.push_back(0x72);//r
            ...
            nAddrValue = (mAddrInfo.nAddrValue/16)*2 + iOffsetAdd;//起始地址

            uchar uctmp1 = PlcMathMethod::intToAsciiValue((nAddrValue >> 12) & 0xf);
            uchar uctmp2 = PlcMathMethod::intToAsciiValue((nAddrValue >> 8) & 0xf);
            uchar uctmp3 = PlcMathMethod::intToAsciiValue((nAddrValue >> 4) & 0xf);
            uchar uctmp4 = PlcMathMethod::intToAsciiValue((nAddrValue >> 0) & 0xf);
            ...
            uctmp1 = PlcMathMethod::intToAsciiValue(((nAddrLen*2) >> 12) & 0xf);
            uctmp2 = PlcMathMethod::intToAsciiValue(((nAddrLen*2) >> 8) & 0xf);
            uctmp3 = PlcMathMethod::intToAsciiValue(((nAddrLen*2) >> 4) & 0xf);
            uctmp4 = PlcMathMethod::intToAsciiValue(((nAddrLen*2) >> 0) & 0xf);
            ...
            mSendPackge.nReturnLen = 5 + nAddrLen*4;
            break;
        }
    case REG_TYPE_D:
    case REG_TYPE_TV:
    case REG_TYPE_CV:
        {
            ...
            nAddrValue = (mAddrInfo.nAddrValue*2) + iOffsetAdd;//起始地址
            ...
            uctmp1 = PlcMathMethod::intToAsciiValue(((mAddrInfo.nAddrLen*2) >> 12) & 0xf);
            uctmp2 = PlcMathMethod::intToAsciiValue(((mAddrInfo.nAddrLen*2) >> 8) & 0xf);
            uctmp3 = PlcMathMethod::intToAsciiValue(((mAddrInfo.nAddrLen*2) >> 4) & 0xf);
            uctmp4 = PlcMathMethod::intToAsciiValue(((mAddrInfo.nAddrLen*2) >> 0) & 0xf);
    ...
    case REG_TYPE_C:
        {
            ...
            if (mAddrInfo.nValueList.size() > 0)
            {
                ...
                {
                    mSendPackge.sendDataList.push_back(0x6e);
                }
            }
            mSendPackge.sendDataList.push_back(0x4d);//M
            ...
            uint nBitPass = mAddrInfo.mAddrProp.nAddrValue%16;

            nAddrValue = nWordPass*2 + iOffsetAdd;//起始地址
            ...
            mSendPackge.sendDataList.push_back(PlcMathMethod::intToAsciiValue(0x30));
            mSendPackge.sendDataList.push_back(PlcMathMethod::intToAsciiValue(0x30));
            ...
            uctmp1 = PlcMathMethod::intToAsciiValue((nAddrLen >> 12) & 0xf);
            uctmp2 = PlcMathMethod::intToAsciiValue((nAddrLen >> 8) & 0xf);
            uctmp3 = PlcMathMethod::intToAsciiValue((nAddrLen >> 4) & 0xf);
            uctmp4 = PlcMathMethod::intToAsciiValue((nAddrLen >> 0) & 0xf);
    ...
    case REG_TYPE_CV:
        {
            ...
            mSendPackge.sendDataList.push_back(0x77);//w
            mSendPackge.sendDataList.push_back(0x4d);//M
            ...
            nAddrValue = mAddrInfo.mAddrProp.nAddrValue*2 + iOffsetAdd;//起始地址
