    ...
    case REG_TYPE_Q:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > ADDR_MAX_VALUE_128 + 1)
            {
                return false;
            }
    ...
    case REG_TYPE_QW:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > ADDR_MAX_VALUE_32 + 1)
            {
                return false;
            }
    ...
    case REG_TYPE_NW:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > ADDR_MAX_VALUE_256 + 1)
            {
                return false;
            }
    ...
    case REG_TYPE_MW:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > ADDR_MAX_VALUE_1024 + 1)
            {
                return false;
            }
    ...
    case REG_TYPE_Q:
        {
            ...
            /*不能为负数*/
            if(nStartValue < 1 || nStartValue > ADDR_MAX_VALUE_128)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= ADDR_MAX_VALUE_128 + 1)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
    ...
    case REG_TYPE_NW:
        {
            ...
            /*不能为负数*/
            if(nStartValue < 1 || nStartValue > ADDR_MAX_VALUE_256)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= ADDR_MAX_VALUE_256 + 1)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
                    sprintf(buf, "%d", nStartValue);
    ...
    case REG_TYPE_MW:
        {
            ...
            /*不能为负数*/
            if(nStartValue < 1 || nStartValue > ADDR_MAX_VALUE_1024)
            {
                return ILLEGAL_VALUE;
            }
    ...
    case REG_TYPE_N:
        {
            ...
            {
            case REG_TYPE_I:
                iOffsetAdd = 0x0000;                                        //0001～0128 00000～00127(十进制)
                break;
            case REG_TYPE_Q:
                iOffsetAdd = 0x0000;                                        //0001～0128 00000～00127
                break;
            case REG_TYPE_M:
                iOffsetAdd = 0x07D0;                                        //0001～1024 02000～03023
                break;
            case REG_TYPE_S:
                iOffsetAdd = 0x07D0;                                        //0001～0256 02000～02255
                break;
            case REG_TYPE_N:
                iOffsetAdd = 0x1B58;                                        //0001～0256 07000～07255
                break;
            default:
                return false;
                break;
    ...
    case REG_TYPE_NW:
        {
            ...
            {
            case REG_TYPE_IW:
                iOffsetAdd = 0x0000;                                        //0001～0032 00000～00031(十进制)
                break;
            case REG_TYPE_QW:
                iOffsetAdd = 0x1F40;                                        //0001～0032 08000～08031
                break;
            case REG_TYPE_MW:
                iOffsetAdd = 0x0000;                                        //0001～1024 00000～01023
                break;
            case REG_TYPE_SW:
                iOffsetAdd = 0x07D0;                                        //0001～0256 02000～02255
                break;
            case REG_TYPE_NW:
                iOffsetAdd = 0x1388;                                        //0001～0256 05000～05255
                break;
            default:
                return false;
                break;
...
bool PlcProtocol::getAddrCanRead(ADDR_TARGET_PROP mAddr)
{
    ...
    case REG_TYPE_Q:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > ADDR_MAX_VALUE_128)
            {
                return false;
            }
            return true;
