    ...
    case REG_TYPE_M:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > 8768)
            {
                return false;
            }
            return bSuccess;
    ...
    case REG_TYPE_CD:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > 640)
            {
                return false;
            }
            return bSuccess;
    ...
    case REG_TYPE_FD:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > 9024)
            {
                return false;
            }
            return bSuccess;
    ...
    case REG_TYPE_ED:
        {
            ...
            /*判断长度是否超限*/
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen > 16384)
            {
                return false;
            }
            return bSuccess;
    ...
    case WORT_ADDR_REG:
        {
            ...
            sRegNameList.push_back("TD");
            sRegNameList.push_back("CD");
            sRegNameList.push_back("FD");
            sRegNameList.push_back("ED");
            break;
        }
    case DWORT_ADDR_REG:
        {
    ...
    case REG_TYPE_M:
        {
            ...
            /*小数部分不能超过16，也不能为负数*/
            if(nStartValue < 0 || nStartValue >= 8768)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= 8768)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
    ...
    case REG_TYPE_CD:
        {
            ...
            /*小数部分不能超过16，也不能为负数*/
            if(nStartValue < 0 || nStartValue >= 640)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= 640)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
                    sprintf(buf, "%d", nStartValue);
    ...
    case REG_TYPE_FD:
        {
            ...
            /*小数部分不能超过16，也不能为负数*/
            if(nStartValue < 0 || nStartValue >= 9024)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= 9024)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
                    sprintf(buf, "%d", nStartValue);
    ...
    case REG_TYPE_ED:
        {
            ...
            /*小数部分不能超过16，也不能为负数*/
            if(nStartValue < 0 || nStartValue >= 16384)
            {
                return ILLEGAL_VALUE;
            }
            ...
            for(int i = 0; i < nCopyNum; i++)
            {
                ...
                if(nStartValue + mTmpAddr.nAddrLen <= 16384)
                {
                    /*添加整数部分*/
                    memset(buf, 0, 10);
                    sprintf(buf, "%d", nStartValue);
    ...
    case REG_TYPE_C:
        {
            ...
            case REG_TYPE_Y:
                ...
                break;
            case REG_TYPE_M:
                if (mAddrInfo.nAddrValue < 8000)
                {
                    iOffsetAdd = 0x0000;
                }
                else//特殊内部线圈时偏移地址不一样
                {
                    mAddrInfo.nAddrValue = mAddrInfo.nAddrValue - 8000;
                    iOffsetAdd = 0x6000;
                }
                break;
            case REG_TYPE_S:
            ...
            nAddrValue = (mAddrInfo.nAddrValue/8)*8 + iOffsetAdd;
    ...
    case REG_TYPE_C:
        {
            ...
            case REG_TYPE_Y:
                ...
                break;
            case REG_TYPE_M:
                if (mAddrInfo.mAddrProp.nAddrValue < 8000)
                {
                    iOffsetAdd = 0x0000;
                }
                else//特殊内部线圈时偏移地址不一样
                {
                    mAddrInfo.mAddrProp.nAddrValue = mAddrInfo.mAddrProp.nAddrValue - 8000;
                    iOffsetAdd = 0x6000;
                }
                break;
            case REG_TYPE_S:
            ...
            nTmpValue = ((mAddrInfo.mAddrProp.nAddrValue + iOffsetAdd) >> 8) & 0xff;
            mSendPackge.sendDataList.push_back(nTmpValue);

            /*vector index = 3*/
            nTmpValue = (mAddrInfo.mAddrProp.nAddrValue + iOffsetAdd) & 0xff;
            mSendPackge.sendDataList.push_back(nTmpValue);
...
bool PlcProtocol::sortOutAddrList(vector<ADDR_TARGET_PROP> mSourceAddrList, vector<ADDR_TARGET_PROP> &targetList, int nMaxRWlen, bool bWriteAddr)
{
    ...
    for(int i = 0; i < nTotalSize; i++)
    {
        ...
        case REG_TYPE_M:
            {
                if (mTmpAddr.nAddrValue < 8000 && mTmpAddr.nAddrValue + mTmpAddr.nAddrLen <= 8000)
                {
...
bool PlcProtocol::getAddrCanRead(ADDR_TARGET_PROP mAddr)
{
    ...
    case REG_TYPE_Y:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > 1038)
            {
                return false;
            }
            return true;
    ...
    case REG_TYPE_M:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > 8768)
            {
                return false;
            }
            return true;
    ...
    case REG_TYPE_CD:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > 640)
            {
                return false;
            }
            return true;
    ...
    case REG_TYPE_D:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > 9024)
            {
                return false;
            }
            return true;
    ...
    case REG_TYPE_ED:
        {
            if(mAddr.nAddrValue < 0 || mAddr.nAddrValue + mAddr.nAddrLen > 16384)
            {
                return false;
            }
            return true;
...
REG_TYPE_INDEX PlcProtocol::getRegTypeFromInt(int nRegIndex)
{
    ...
    case 7:
        {
            eRegType = REG_TYPE_TD;
            break;
        }
    case 8:
        {
            eRegType = REG_TYPE_CD;
            break;
        }
    case 9:
        {
            eRegType = REG_TYPE_FD;
            break;
        }
    case 10:
        {
            eRegType = REG_TYPE_ED;
            break;
        }
    default:
        {
...
bool PlcProtocol::getRegIndexFromName(string sRegName, int &nRegIndex)
{
    ...
    else if((DealWithString::compare("TD", sRegName)))
    {
        nRegIndex = 7;
        return true;
    }
    else if((DealWithString::compare("CD", sRegName)))
    {
        nRegIndex = 8;
        return true;
    }
    else if((DealWithString::compare("FD", sRegName)))
    {
        nRegIndex = 9;
        return true;
    }
    else if((DealWithString::compare("ED", sRegName)))
    {
        nRegIndex = 10;
        return true;
    }
