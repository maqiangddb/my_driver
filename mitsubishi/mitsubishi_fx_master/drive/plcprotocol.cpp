    ...
    case REG_TYPE_SD:
        {
            ...
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen - ADDR_MAX_VALUE_8000 > ADDR_MAX_VALUE_1000)
            {
                return false;
            }
    ...
    case REG_TYPE_32CV:
        {
            ...
            if(mAddrTarget.nAddrValue + mAddrTarget.nAddrLen/2 > ADDR_MAX_VALUE_256 - 1)
            {
                return false;
            }
    ...
    case CMN_READ_BEFORE_WRITE:
        {
            if(REG_TYPE_D_BIT == eRegType)
            {
                ...
                int nSendAdd = (mAddrInfo.mAddrProp.nAddrValue/16)*2 + 0x1000;
