    ...
    case REG_TYPE_0X:
        {
            ...
            else       //如果是从PLC读取的数据
            {
                ...
                {
                    readDataList.regBitList[0].resize(mAddr.nAddrValue + nListSize *8, emptyBitValue);
                }
    ...
    case REG_TYPE_1X:
        {
            ...
            else       //如果是从PLC读取的数据
            {
                ...
                if(nSize < mAddr.nAddrValue + nListSize *8)
                {
                    readDataList.regBitList[1].resize(mAddr.nAddrValue + nListSize *8, emptyBitValue);
                }
